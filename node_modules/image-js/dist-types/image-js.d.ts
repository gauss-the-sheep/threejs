...
export declare interface ConvexityDefectsOptions {
    /**
 ...
 */
export declare function getConvexityDefects(borderPoints: Point[], hullPoints: Point[], options?: ConvexityDefectsOptions): Point[];
...
declare type GetExternalContourOptions = Omit<GetBorderPointsOptions, 'innerBorers'>;
